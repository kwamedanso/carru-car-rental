                    ...
                    <div className="hero__content">
                        <div className="hero-content_text">
                            ...
                            <div className="hero__content__buttons">
                                <Link data-type='inverted' data-attr='block-button' className='button margin-rt-100' to='/vehicles' state={{ data: 'Luxury' }}>Booking Now</Link>
                                <Link to='/vehicles' state={{ data: 'Vintage' }}>See all cars</Link>
                            </div>
                        </div>
                        <div className="hero__bg flex-container">
                            <img className='hero__bg-img' src={background} alt="" />
                        </div>
                    </div>
                </div>
            </section >
